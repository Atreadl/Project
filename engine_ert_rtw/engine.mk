###########################################################################
## Makefile generated for component 'engine'. 
## 
## Makefile     : engine.mk
## Generated on : Fri Apr 17 13:14:23 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/engine.exe
...
COMPILER_COMMAND_FILE     = engine_comp.rsp
CMD_FILE                  = engine.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/engine.exe
...
DEFINES_STANDARD = -DMODEL=engine -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/engine_ert_rtw/engine.c

MAIN_SRC = $(START_DIR)/engine_ert_rtw/ert_main.c
...
%.obj : $(START_DIR)/engine_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/engine_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/engine_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/engine_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/engine_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
engine.obj : $(START_DIR)/engine_ert_rtw/engine.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/engine_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
